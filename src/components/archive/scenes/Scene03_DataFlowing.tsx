...
const NODES = [
  {
    icon: Database,
    label: "Statcast",
    stat: content.data_flow.nodes[0].volume ?? "",
    description: content.data_flow.nodes[0].description,
  },
  {
    icon: Filter,
    label: "Processing",
    stat: `${content.overview.key_stats[0].value} at-bats`,
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
      <div className="w-full max-w-3xl">
        ...
        >
          {content.overview.key_stats[2].value} {content.overview.key_stats[2].label} trained this AI
        </motion.p>
